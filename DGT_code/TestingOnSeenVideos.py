...
def train(X, Y,Tl,Xe,Ye,Tle,data_name):
    ...
    tree.loadPre('../weights/base_weights/Large_YOVOS_weights_19.npy')
    tree.load('../weights/growing_tree_weights/Large_tree_weights_full.npy')
    previous_tasks = tree.datasetMapping[data_name]
    tasks = len(X)
