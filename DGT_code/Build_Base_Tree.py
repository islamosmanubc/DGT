...
def getfiles(dataset):
    ...
    if dataset == 'base':
        ...
        pathf = basepath+'datasets/segtrackv2/JPEGImages1'
        tasks = os.listdir(pathf)
        ...
        for task in tasks:
            ...
            X_list[-1].append(glob.glob(os.path.join(pathf,'JPEGImages1',task, 'input','*.png')))
        ...
        pathf = basepath+'datasets/davis17/DAVIStrain/Annotations/GT'
        tasks = os.listdir(pathf)
        pathf = basepath+'datasets/davis17/DAVIStrain'
        for task in tasks:
            Y_list.append([])
            X_list.append([])
            Y_list[-1].append(glob.glob(os.path.join(pathf,'Annotations/GT',task, '*.png')))
            X_list[-1].append(glob.glob(os.path.join(pathf,'JPEGImages/input', task,'*.jpg')))
